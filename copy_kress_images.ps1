$sourceDir = "C:\Users\conor\Documents\Lomax Website Anti Gravity\Lomax Construction Website\Project Photos\Kress_Building"
...
foreach ($file in $files) {
    $newName = "kress-building-gallery-$counter.jpg"
